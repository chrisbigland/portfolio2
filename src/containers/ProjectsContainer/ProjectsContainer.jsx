...
<div>
      ...
      <h2 className={styles.Projects_title}>My Projects</h2></div>
      ...
      <div className={styles.Projects} >
          ...
          <div className={styles.Projects_project}>
              ...
              <p className={styles.projects_projText}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
               ...
               <div className={styles.Projects_codPrevIcons}>
                  <a href="#">code <img src={devSymbol} alt="developer symbol"></img></a>
                  <a href="#">preview <img src={eyeSymbol} alt="eye symbol"></img></a>
              </div>
          </div>
          ...
          <div className={styles.Projects_project}>
              ...
              <span className={styles.Projects_projSectTitle}>Ticket Tracker</span>
              <p className={styles.projects_projText}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                  Assumenda, odio at perspiciatis, corrupti blanditiis tempore 
                  sint illum laudantium iusto neque molestias quis veniam labore facilis.</p>
              <div className={styles.Projects_codPrevIcons}>
          ...
          <div className={styles.Projects_project}>
              <span className={styles.Projects_projectBox}></span>
              <span className={styles.Projects_projTool}>REACT</span>
              <span className={styles.Projects_projSectTitle}>Hostile Aliens</span>
              <p className={styles.projects_projText}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                  Assumenda, odio at perspiciatis, corrupti blanditiis tempore 
                  sint illum laudantium iusto neque molestias quis veniam labore facilis.</p>
              <div className={styles.Projects_codPrevIcons}>
          ...
          <div className={styles.Projects_project}>
              ...
              <span className={styles.Projects_projSectTitle}>Portuguese Pairs Game</span>
              <p className={styles.projects_projText}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                  Assumenda, odio at perspiciatis, corrupti blanditiis tempore 
                  sint illum laudantium iusto neque molestias quis veniam labore facilis.</p>
              <div className={styles.Projects_codPrevIcons}>
          ...
          <div className={styles.Projects_project}>
              <span className={styles.Projects_projectBox}></span>
              <span className={styles.Projects_projTool}>REACT</span>
              <span className={styles.Projects_projSectTitle}>Morse Code Translator</span>
              <p className={styles.projects_projText}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                  Assumenda, odio at perspiciatis, corrupti blanditiis tempore 
                  sint illum laudantium iusto neque molestias quis veniam labore facilis.</p>
              <div className={styles.Projects_codPrevIcons}>
