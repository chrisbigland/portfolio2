  ...
  return (
    <div className={styles.Footer}>
        ...
        <div className={styles.Footer_icons}>
            <a className={styles.Footer_link} download href="./CV/christopher-bigland-cv-public-version.pdf"><img className={styles.Footer_contentIcon} src={cVIcon} alt="CV icon"></img></a>
